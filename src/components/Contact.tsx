    ...
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          {/* Left content */}
          <div>
            <span className="text-[#00FF66] font-semibold text-sm uppercase tracking-wider">Get Started</span>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-[#00FF66] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            {submitted ? (
              <div className="text-center py-12">
                <div className="w-16 h-16 bg-[#00FF66]/20 rounded-full flex items-center justify-center mx-auto mb-6">
